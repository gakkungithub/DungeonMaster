...
public class MapGenerator : SingletonMonoBehaviour<MapGenerator>
{
    ...
    {
        //シーンの中だけのSignletonとするのでflagを立てる
        ...
        var retirePoint = -1;
        //DungeonHierarchyCounterに記録されているクリア階層が5の倍数ならRetirePointを生成する
        ...
        RenderMap(map);
        //敵を生成する
        this.GetComponent<EnemySpawner>().EnemySpawn(EnemyPos.FirstOrDefault(), EnemyParameterBase.EnemyType.Normal);
